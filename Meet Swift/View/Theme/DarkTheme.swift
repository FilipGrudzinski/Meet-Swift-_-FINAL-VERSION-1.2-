...
class DarkTheme: ThemeProtocol {
    ...
    var cellBackgroundColor = #colorLiteral(red: 0.07058823529, green: 0.07058823529, blue: 0.07058823529, alpha: 0.9) //#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) //#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
