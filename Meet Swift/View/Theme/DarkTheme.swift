...
class DarkTheme: ThemeProtocol {
    ...
    var cellBackgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)//#colorLiteral(red: 0.07058823529, green: 0.07058823529, blue: 0.07058823529, alpha: 0.9)
    var selectedRow = #colorLiteral(red: 1, green: 0.5781051517, blue: 0, alpha: 0.1)
    var headerBackgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)//#colorLiteral(red: 0.0505625, green: 0.0505625, blue: 0.0505625, alpha: 1)//#colorLiteral(red: 0.08537990196, green: 0.08537990196, blue: 0.08537990196, alpha: 1)
